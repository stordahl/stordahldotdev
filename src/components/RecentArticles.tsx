...
const recent_articles: RecentArticle[] = [
  {
    description: "Over the past year, like many JavaScript developers, I have fallen in love with Bun. However, recent choices made by the Bun team have started to taint these feelings.",
